...
{% macro show_link(week_num, icon, page) -%}<small><small><a href="week{{ week_num }}/{{ page }}" class="badge bg-body-tertiary text-body-emphasis me-1">%%{{ icon }}%%</a></small></small>{%- endmacro %}
