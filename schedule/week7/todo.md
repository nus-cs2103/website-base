...
<include type="success" src="../../admin/appendixC-faq.md#admin-faq-favoriteTool" name="%%Admin &raquo;%% FAQ: Why I'm not allowed to use my favorite tool/framework/language etc.? :star::star::star::star:" dynamic />
