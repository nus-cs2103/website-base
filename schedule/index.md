...
      {location: ["gitAndGithub", "managePRs"]},
  {name: ":parking: Project"},
    {heading: "Can define requirements of a product", priority: "1", file: "project.md#requirements"},
{week: "5"},
  {name: "Design"},
  ...
  {name: ":parking: Project"},
    ...
    {heading: "Can conceptualize a product", priority: "1", file: "project.md#conceptualize"},
{week: "6"},
  {name: "Requirements"},
