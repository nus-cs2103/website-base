...
{week: "3"},
  ...
  {name: "Other"},
    {heading: "Can work with a 1KLoC code base ==[Compulsory]==", priority: "1", file: "project.md#1kloc"},
{week: "4"},
  {name: "Design"},
...
{week: "5"},
  ...
  {name: "Other"},
    {heading: "Can work with a 2KLoC code base ==[Compulsory]==", priority: "1", file: "project.md#2kloc"},
{week: "6"},
  {name: "Requirements"},
