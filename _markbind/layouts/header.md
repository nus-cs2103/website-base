...
<div tags="m--cs2103 m--cs2113 m--te3201" class="w-100 p-1 bg-success text-center text-white d-print-none"><md>This module will be **fully online** this semester. There is no need for on-campus presence.</md></div>
...
{% endfor %}
  ...
  <dropdown tags="m--cs2103 m--cs2113 m--tic4001 m--tic4002" header="**Project Links**" class="nav-link">
    ...
    <li tags="m--cs2113"><a href="{{url_module_org}}/{{ tp_repo_name }}" target="_blank" class="dropdown-item"><md>{{ icon_repo }} tP Upstream Repo</md></a></li>
    ...
    <li tags="m--cs2113"><a href="{{url_ab3_upstream_website}}" target="_blank" class="dropdown-item"><md>{{ icon_repo }} Reference AB3</md></a></li>
  </dropdown>
  <dropdown header="**{{ "Other " if not tic2002 or te3201 else ""}}Links**" class="nav-link">
    ...
    <li tags="m--cs2113 m--te3201"><a href="{{url_coursemology_classroom}}" target="_blank" class="dropdown-item"><md>{{ icon_exercise }} Coursemology link</md></a></li>
