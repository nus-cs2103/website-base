...
{% endif %}
  ...
  <dropdown header="**{{ "Other " if not tic2002 or tee3201 else ""}}Links**" class="nav-link">
    ...
    <li tags="m--cs2103 m--cs2113"><a highlight-on="none" href="https://git-mastery.org/#/{{ course | lower }}" class="dropdown-item" target="_blank"><md>:fas-route: Git-Mastery Website ({{ course }} edition)</md></a></li>
