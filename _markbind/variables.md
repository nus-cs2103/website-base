...
<variable name="current_week">0</variable> <!-- after semester ends, set this to 15 and enable built-in search in site.json -->
...
<variable name="lecture_venue">I3 AUD</variable>
