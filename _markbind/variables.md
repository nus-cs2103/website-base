...
<variable name="current_week">5</variable> <!-- after semester ends, set this to 15 and enable built-in search in site.json -->

<variable name="algolia">yes</variable>

<variable name="canvas_course_id">93760</variable>
...
<variable name="show_feature_freeze_dashboards">no</variable>
