...
<variable name="current_week">7</variable> <!-- after semester ends, set this to 15 and enable built-in search in site.json -->

<variable name="algolia">yes</variable>

<variable name="canvas_course_id">77826</variable>
