...
{% endfor %}
  ...
  <dropdown text="Links" class="nav-link">
    ...
    <li><a href="https://github.com/se-edu/addressbook-level1" target="_blank" class="dropdown-item"><md>{{ icon_repo }} Addressbook-level1</md></a></li>
    <li><a href="https://github.com/se-edu/addressbook-level2" target="_blank" class="dropdown-item"><md>{{ icon_repo }} Addressbook-level2</md></a></li>
    <li><a href="{{module_org}}/addressbook-level3" target="_blank" class="dropdown-item"><md>{{ icon_repo }} Addressbook-level3</md></a></li>
    <li><a href="https://github.com/se-edu/addressbook-level4" target="_blank" class="dropdown-item"><md>{{ icon_repo }} Addressbook-level4</md></a></li>
