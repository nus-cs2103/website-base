...
{% endfor %}
  ...
  <dropdown header="**Links**" class="nav-link">
    ...
    <li tags="cs2113"><a href="{{repl_link}}" target="_blank" class="dropdown-item"><md>{{ icon_exercise }} `repl.it` link</md></a></li>
    ...
    <li tags="cs2103"><a href="{{module_org}}/addressbook-level3" target="_blank" class="dropdown-item"><md>{{ icon_repo }} Addressbook-level3</md></a></li>
