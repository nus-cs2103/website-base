...
{% set teams = {
 ...
 'CS2103T-T08-4': 'https://docs.google.com/document/d/14u8qwtOxQ88Iq4UyEIcmxVXSB1dVC9AGdSYdZimFtZ8/edit?usp=sharing',
...
{% set products = {
 ...
 'CS2103T-T15-2': 'Classify (read as class-ify)',
...
{% set users = {
 ...
 'CS2103T-W16-1': "Members in a software engineering team (who prefer CLI over GUI). These users have frequent tasks and meetings to keep track of, and would want to know each others' schedules and ongoing tasks in a time-efficient manner.",
...
{% set values = {
 ...
 'CS2103T-W16-1': 'TeamBase is a one stop contact system, where members can easily see the tasks and schedules of their software engineering colleagues. It would be useful for the users to get information about their colleagues, rather than wait for their replies, which would boost productive efficiency.',
