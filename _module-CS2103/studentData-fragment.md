...
{% set values = {
 ...
 'CS2103T-W08-1': 'HealthContact is a one-stop app that helps the receptionist of family clinics to manage and keep track of patient details and information such as appointments, bills and medication for telemedicine services, especially for those clinics without a mobile app to expedite the process.',
