...
{week: "4"},
  {name: "Design"},
    ...
    {heading: "Class Diagrams: Beyond Basics", panopto: "9e6f5f1a-5596-498e-86f6-ac1b00e43a38", questions:"y"},
...
{week: "5"},
  {name: "Requirements"},
    {heading: "Requirements: Intro"},
      ...
      {location: ["requirements", "changing"]},
    {heading: "Requirements: Gathering", panopto: "e9253486-b36d-4d7f-8044-ac2900bd46d1"},
      ...
      {location: ["gatheringRequirements", "validation"]},
...
{week: "6"},
  {name: "Design"},
    ...
    {heading: "Architecture Diagrams", panopto: "78d19b38-cd7c-453e-86e1-ac3000d6984c"},
      ...
      {location: ["architecture", "introduction", "why"]},
      {location: ["architecture", "introduction", "components"]},
      {location: ["architecture", "architectureDiagrams", "views"]},
      {location: ["architecture", "architectureDiagrams", "reading"]},
      {location: ["designApproaches", "multilevelDesign", "what"]},
  {name: "Implementation"},
    {heading: "Debugging"},
      {location: ["debugging", "what"], panopto: "4a778a0b-e16a-4318-a1c4-ac2800e20e48"},
      {location: ["debugging", "how"]},
      {location: ["debugging", "fixing"]},
      {location: ["debugging", "tools"]},
      {location: ["debugging", "advanced"]},
...
{week: "7"},
  {name: "Requirements"},
    ...
    {heading: "Requirements Documents"},
        {location: ["specifyingRequirements", "requirementsDocument", "what"]},
  {name: "Design"},
...
{week: "11"},
  {name: "Design"},
    ...
    {heading: "Architectural Styles", panopto: "beba35ca-1fc0-4d0a-bf99-ac5900deda23"},
      ...
      {location: ["architecture", "architecturalStyles", "monolith", "what"]},
