...
{% set values = {
 ...
 'CS2103T-T15-1': 'HRQuickAccess provides HR personnel with fast, keyboard-focused access to essential troop information, including contact details and duty dates.<br>Rational: Singapore Armed Forces (SAF) primarily issue and utilize laptops with security cards within army camps; as such, tech accessories such as mouses and additional monitors are less common and applicable. Through, command line interface (CLI) interface, we can overcome this constraint.<br><br>HRQuickAccess does not require internet access to opera...',
