...
**Giving credit for reusing from course materials** (e.g., course textbook, tutorials, resources from se-education.org) is not required, although you are welcome to do so. Reason: Those materials were created by the teaching team for you to use/reuse.
