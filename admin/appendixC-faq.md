...
* be considered helpful by peers (based on peer evaluations and tutor observations)
  * In particular, you are encouraged to be active on the slack channel and our [forum](https://github.com/nus-cs2103-AY1718S2/forum/issues) and give your inputs to ongoing discussions so that other students can benefit from your relatively higher expertise that makes you deserve an A+.
