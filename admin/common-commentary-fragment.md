...
* **You still need to know the coding standard and other good code hygene practices, because you are the one accepting the code.** If you cannot recognize a code quality issue, you cannot tell whether what the agent produced is good enough.
{% endcall %}
</div>
<!-- ------------------------------------------------------------------------------------------------------ -->
