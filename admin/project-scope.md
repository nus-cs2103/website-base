...
#### [{{ icon_individual }} Individual] Expectation 1: Contribute at least one feature to the product

* ==One big feature can earn you more marks than multiple small features.== %%Reason: When grading your work for dpth and completeness, only your biggest feature you will be considered.%%
...
#### [{{ icon_individual }} Individual] Expectation 2: contribute to multiple aspects of the project
...
#### [{{ icon_individual }} Individual] Expectation 3: Share team-tasks and roles of the project
