...
* **Any queries regarding admin matters** should be sent to the course email (`cs2113@comp.nus.edu.sg`) or posted in the [course forum]({{ url_forum }}) (do not send them to the tutor).
</box>
