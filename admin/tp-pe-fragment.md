...
* **The PE is divided into four phases**:
  * ****Phase 1: Bug Reporting****{.text-success}: <span id="pe-p1-desc">In this phase, you will test the allocated product and report bugs, similar to PE-D. This phase is divided further into parts I ... IV. The recommended order and the recommended duration of each part is given below. you will be given about **24 hours (Friday 12 noon to Saturday 12 noon) to finish this phase**.<br>
    **We recommend that you do it during the lecture slot, or earlier** (reason: support from the teaching team will be available only during that time).</span>
