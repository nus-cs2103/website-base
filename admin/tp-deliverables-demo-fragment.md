...
#### <span class="badge text-bg-info">Demo</span> <span class="text-info">Duration</span>
...
#### <span class="badge text-bg-info">Demo</span> <span class="text-info">Target audience</span>
...
#### <span class="badge text-bg-info">Demo</span> <span class="text-info">Scope</span>
...
#### <span class="badge text-bg-info">Demo</span> <span class="text-info">Structure</span>
...
#### <span class="badge text-bg-info">Demo</span> <span class="text-info">Tips</span>
...
#### <span class="badge text-bg-info">Demo</span> <span class="text-info">Special circumstances</span>
