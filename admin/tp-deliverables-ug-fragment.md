...
**{{ course }}T does not require you to indicate author name of DG/UG sections**{% if cs2103%} (CS2101 requirements may differ){% endif %}. We recommend (but not require) you to ensure that the code dashboard reflect the authorship of doc files accurately.
</div>
