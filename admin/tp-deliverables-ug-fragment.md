...
**{{ course }} does not require you to indicate author name of DG/UG sections**. We recommend (but not require) you to ensure that the code dashboard reflect the authorship of doc files accurately.
</div>
