...
<h3 class="d-block text-bg-info p-1 ps-2 mt-4 mb-3">Deliverable: Executable</h3>
...
<h3 class="d-block text-bg-info p-1 ps-2 mt-4 mb-3">Deliverable: Source code</h3>
...
<h3 class="d-block text-bg-info p-1 ps-2 mt-4 mb-3">Deliverable: User Guide (UG)</h3>
...
<h3 class="d-block text-bg-info p-1 ps-2 mt-4 mb-3">Deliverable: Developer Guide (DG)</h3>
...
<h3 class="d-block text-bg-info p-1 ps-2 mt-4 mb-3">Deliverable: Product Website</h3>
...
<h3 class="d-block text-bg-info p-1 ps-2 mt-4 mb-3">Deliverable: Project Portfolio Page (PPP)</h3>
...
<h3 class="d-block text-bg-info p-1 ps-2 mt-4 mb-3">Deliverable: Demo</h3>
